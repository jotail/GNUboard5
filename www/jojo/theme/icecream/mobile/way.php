...
var mapContainer = document.getElementById('map'), // 지도를 표시할 div 
    mapOption = { 
        center: new daum.maps.LatLng(37.334306, 126.809861), // 지도의 중심좌표
        level: 3 // 지도의 확대 레벨
    };
...
// 마커가 표시될 위치입니다 
var markerPosition  = new daum.maps.LatLng(37.334306, 126.809861); 
...
var iwContent = '<div style="padding:5px;">Hello Kimchulyong! <br><a href="http://map.daum.net/link/map/Hello World!,37.334306, 126.809861" style="color:blue" target="_blank">큰지도보기</a> <a href="http://map.daum.net/link/to/Hello World!,37.334306, 126.809861" style="color:blue" target="_blank">길찾기</a></div>', // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
    iwPosition = new daum.maps.LatLng(37.334306, 126.809861); //인포윈도우 표시 위치입니다
